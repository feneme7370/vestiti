<!-- Create Modal -->
<div wire:ignore.self class="modal fade" id="addDiseaseModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <div wire:loading.remove>
            <form wire:submit.prevent="storeDisease">
                <div class="modal-body">
                    <fieldset class="t_fieldset">
                        <legend class="t_legend">Enfermedad</legend>
    ...
    <!-- Edit Modal -->
    <div wire:ignore.self class="modal fade" id="updateDiseaseModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Editar Enfermedad</h5>
                <button type="button" wire:click="closeModal" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
    ...
    <!-- Delete Modal -->
    <div wire:ignore.self class="modal fade" id="deleteDiseaseModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Eliminar Enfermedad</h5>
                <button type="button" wire:click="closeModal" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            ...
            {{-- cargado --}}
            <div wire:loading.remove>
                <form wire:submit.prevent="destroyDisease">
                    <div class="modal-body">
