<!-- Create Modal -->
<div wire:ignore.self class="modal fade" id="addCampaignModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            ...
            <form wire:submit.prevent="storeCampaign">
                <div class="modal-body">
                    <fieldset class="t_fieldset">
                        <legend class="t_legend">Cosecha</legend>
    ...
    <!-- Edit Modal -->
    <div wire:ignore.self class="modal fade" id="updateCampaignModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Editar Cosecha</h5>
                <button type="button" wire:click="closeModal" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
    ...
    <!-- Delete Modal -->
    <div wire:ignore.self class="modal fade" id="deleteCampaignModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLongTitle">Eliminar Cosecha</h5>
                <button type="button" wire:click="closeModal" class="close" data-dismiss="modal" aria-label="Close">
                <span aria-hidden="true">&times;</span>
                </button>
            </div>
            ...
            {{-- cargado --}}
            <div wire:loading.remove>
                <form wire:submit.prevent="destroyCampaign">
                    <div class="modal-body">
