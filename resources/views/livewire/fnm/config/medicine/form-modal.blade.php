<!-- Create Modal -->
<div wire:ignore.self class="modal fade" id="addMedicineModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    ...
    <!-- Edit Modal -->
    <div wire:ignore.self class="modal fade" id="updateMedicineModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            {{-- cargado --}}
            <div wire:loading.remove>
                <form wire:submit.prevent="updateMedicine">
                    <div class="modal-body">
                        <fieldset class="t_fieldset">
    ...
    <!-- Delete Modal -->
    <div wire:ignore.self class="modal fade" id="deleteMedicineModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
            <div class="modal-header">
            ...
            {{-- cargado --}}
            <div wire:loading.remove>
                <form wire:submit.prevent="destroyMedicine">
                    <div class="modal-body">
